...
# ===========================================
# Load model
model_google = gensim.models.Word2Vec.load_word2vec_format('./GoogleModel/GoogleNews-vectors-negative300.bin', binary=True)
...
Word2Vec.storeVecs(train_vectors, './data for input/word_vecs.txt')
